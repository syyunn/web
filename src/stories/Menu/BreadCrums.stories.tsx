    ...
    return (
        <header className="bg-white black-80 avenir">
            <nav className="mw10 ph2 nowrap overflow-x-auto">
                <a className="f6 f5-l link bg-animate black-80 hover-bg-light-yellow dib pa3 ph4-l" href="https://drive.google.com/open?id=16zXC9GBdoXqgcdLn7jeTenDJVdPuL72U">About</a>
