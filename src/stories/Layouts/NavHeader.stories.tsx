...
export const NavigationHeaderWithTextLogoWithoutBorderBottomLine = () => NavigationHeader({ height: 70, logo: Heading({ text: "DeepWTO : Learn to Predict Invokable Articles in WTO using Deep Learning " }), bgColor: "white", bbColor: 'silver', text: Heading({ text: "Level 1 Heading" }) });
